...
public final class LocationExtensions {
     ...
     */
    public static List<DistancePoint> getDistancePoints(final Position startPoint, final List<Position> geohashes, final MeasuringUnit unit) {
     ...
     */
    public static String getGeohashFromIpAddress(final LookupService lookupService, final String ipAddress) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     *         is found.
     */
    public static GeoHashPoint getGeoHashPoint(final LookupService lookupService, final String ipAddress) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @return the list
     */
    public static List<Position> sortByDistance(final Position startPoint, final List<Position> geohashes, final MeasuringUnit unit) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @return the list
     */
    public static List<Position> sortByDistanceInMeters(final Position startPoint, final List<Position> geohashes) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
